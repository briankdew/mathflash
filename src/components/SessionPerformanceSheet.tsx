...
function formatProblem(problem: SessionProblemPerformance) {
...
function modeLabel(mode: 'keypad' | 'voice') {
  return mode === 'voice' ? 'Voice' : 'Keypad';
}

function onsetSourceSummary(report: SessionPerformanceReport) {
